...
We will be conducting variable analysis via the graphical method of a bar plot and the numerical method of a summary (mean, minimum, standard deviation, etc.) of the data. We will need the data manipulation of filtering to retrieve only the females from the "gender" variable. The inferential tools of the chi-squared and Fisher's exact test will also be utilized to help finalize our answer to the research question.
